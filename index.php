...
<html>
	...
	<body>
		...
		<div data-role="footer" data-theme="<?php echo $theme ?>">
			<h1>Powered by <a href="http://mobilegrows.com/">MobileGrows</a> | <a href="http://imaveghead.com/" rel="external">Desktop Site</a></h1>
		</div>
		<!-- page 1 ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////-->
		<div data-role="page" id="page1" data-theme="<?php echo $theme ?>">
		  ...
		  <div data-role="main" class="ui-content" data-theme="<?php echo $theme ?>">
				...
				<div class="ui-grid-solo" data-theme="<?php echo $theme ?>">
                    <div class="ui-block-a buttons-semir "><a class="ui-btn ui-alt-icon ui-nodisc-icon ui-icon-clock ui-btn-icon-left buttons-radius" href="#home" data-transition="<?php echo $transitionefect ?>">Menu</a></div>                 
				</div>
				<div class="ui-grid-a" data-theme="<?php echo $theme ?>">
                    <div class="ui-block-a buttons-semir "><a class="ui-btn ui-alt-icon ui-nodisc-icon ui-icon-clock ui-btn-icon-left buttons-radius" href="#home" data-transition="<?php echo $transitionefect ?>">Our Recycling<br>Program</a></div>
                    <div class="ui-block-b buttons-semir "><a class="ui-btn ui-alt-icon ui-nodisc-icon ui-icon-info ui-btn-icon-right buttons-radius" href="#home" data-transition="<?php echo $transitionefect ?>">School Lunch<br>Program</a></div>
				</div>
				<div class="ui-grid-a" data-theme="<?php echo $theme ?>">
                    <div class="ui-block-a buttons-semir "><a class="ui-btn ui-alt-icon ui-nodisc-icon ui-icon-clock ui-btn-icon-left buttons-radius" href="#home" data-transition="<?php echo $transitionefect ?>">Awards</a></div>
                    <div class="ui-block-b buttons-semir "><a class="ui-btn ui-alt-icon ui-nodisc-icon ui-icon-info ui-btn-icon-right buttons-radius" href="#home" data-transition="<?php echo $transitionefect ?>">Reviews</a></div>
				</div>
				<div class="ui-grid-a" data-theme="<?php echo $theme ?>">
                    <div class="ui-block-a buttons-semir "><a class="ui-btn ui-alt-icon ui-nodisc-icon ui-icon-clock ui-btn-icon-left buttons-radius" href="#home" data-transition="<?php echo $transitionefect ?>">Cooking<br>Classes</a></div>
		  ...
		  <h2>The New Fast Food For The 21st Century</h2>
            <p>The Veg Head is a low impact, ecological food service carry out.  We have two separate grills, one for preparing vegetarian foods and the other for non-vegetarian foods. Our sandwiches are served on a whole grain bun. 
            Our wraps and za's are served on whole grain shells as well.</p>
				...
				<div class="ui-grid-solo" data-theme="<?php echo $theme ?>">
					<section id="navigation-menu-home">
						<ul id="menu-home">
							...
							<li><a href="#page1" data-transition="<?php echo $transitionefect ?>">Our Recycling Program</a></li>	
							<li><a href="#page1" data-transition="<?php echo $transitionefect ?>">School Lunch Program</a></li>	
							<li><a href="#page1" data-transition="<?php echo $transitionefect ?>">Cooking Classes</a></li>	
							<li><a href="#page1" data-transition="<?php echo $transitionefect ?>">Awards</a></li>	
